...
.factory('Rules', function (layers, $filter) {
  ...
  rules.elements_keywords = new Rule({
  ...
  rules.elements_have_names = new Rule({
  ...
  rules.bmc_customer_perspective_complete = new Rule({
    ...
    rule: function(rule){
      ...
      var typeLookup = function(x, t){ return x + ' ' + $filter('i18n')(bmoTypeToZoneKey[t]);};
      for(tagId in tagIds){
        ...
        if(requiredTypes.length > 0){
          ...
          rule.addError({name:tag.name + ' missing: ' +
            requiredTypes.reduce(typeLookup, '') +
            ' optional: ' + optionalTypes.reduce(typeLookup, '')
          });
  ...
  rules.bmc_split_multisided = new Rule({
  ...
  rules.bmc_vp_detail_level = new Rule({
  ...
  rules.bmc_vp_produced = new Rule({
  ...
  rules.bmc_tag_not_block = new Rule({
  ...
  rules.help_right_side = new Rule({
  ...
  rules.help_financial_side = new Rule({
  ...
  rules.tags_are_subset = new Rule({
  ...
  */
  ...
  rules.add_detail_revenue = new Rule({
  ...
  rules.add_detail_cost =  new Rule({
  ...
  rules.trigger_recurring_revenue = new Rule({
  ...
  rules.trigger_switching_cost = new Rule({
  ...
  rules.trigger_cost_structure = new Rule({
  ...
  rules.trigger_more_partners = new Rule({
  ...
  rules.pattern_unbundling = new Rule({
    title: 'Unbundling',
    fix: '',
    category: 'pattern',
    why: '',
  ...
  rules.pattern_multisided = new Rule({
    title: 'Multi-sided',
    fix: '',
    category: 'pattern',
    why: '',
  ...
  rules.pattern_freemium = new Rule({
    title: 'Freemium',
    fix: '',
    category: 'pattern',
    why: '',
  ...
  rules.pattern_bait_hook = new Rule({
    title: 'Bait & Hook',
    fix: '',
    category: 'pattern',
    why: '',
  ...
  rules.compare_to_exercice = new Rule({
